...
import com.example.ApiRestClinica.config.jwt.JwtRequestFilter;
import com.example.ApiRestClinica.service.jwt.JwtUserDetailsService;
...
*/
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                ...
                .and()
                .authorizeRequests().antMatchers("/authenticate", "/swagger-ui/**", "/v3/api-docs/**")
