package com.example.ApiRestClinica.mvc.serviceTestsIntegracion;

import com.example.ApiRestClinica.model.Odontologo;
import com.example.ApiRestClinica.model.Turno;
import com.example.ApiRestClinica.util.Jsons;
...
public class OdontologoServiceTestIntegracion {
    ...
    public void registrarOdontologo() throws Exception {
        Odontologo od = new Odontologo("Raton", "Perez", "126");
